...
import 'package:triacore_mobile/screens/send_funds/confirm_send_transaction.dart';
import 'package:triacore_mobile/screens/send_funds/widgets/available_funds.dart';
import 'package:triacore_mobile/screens/send_funds/widgets/inputs.dart';
import 'package:triacore_mobile/widgets/appbar.dart';
import 'package:triacore_mobile/widgets/buttons.dart';
import 'package:triacore_mobile/widgets/inputs/amount_input.dart';
...
class SendFundsScreenState extends ConsumerState<SendFundsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: TriacoreAppBar(title: "Enviar ativos"),
      body: Padding(

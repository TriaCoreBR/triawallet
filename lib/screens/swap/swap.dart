...
import 'package:triacore_mobile/models/sideswap.dart';
import 'package:triacore_mobile/providers/multichain/owned_assets_provider.dart';
import 'package:triacore_mobile/providers/peg_operation_provider.dart';
import 'package:triacore_mobile/providers/sideswap_repository_provider.dart';
import 'package:triacore_mobile/providers/wallet/liquid_provider.dart';
import 'package:triacore_mobile/repositories/wallet/liquid.dart';
import 'package:triacore_mobile/screens/pin/verify_pin.dart';
import 'package:triacore_mobile/screens/swap/check_peg_status.dart';
import 'package:triacore_mobile/screens/swap/confirm_peg.dart';
import 'package:triacore_mobile/screens/swap/finish_swap.dart';
import 'package:triacore_mobile/screens/swap/widgets/available_funds.dart';
import 'package:triacore_mobile/screens/swap/widgets/market_dropdown.dart';
import 'package:triacore_mobile/screens/swap/widgets/peg_available_funds.dart';
import 'package:triacore_mobile/screens/swap/widgets/server_status.dart';
import 'package:triacore_mobile/screens/swap/widgets/peg_input_display.dart';
import 'package:triacore_mobile/screens/swap/widgets/sideswap_quote_display.dart';
...
class SwapScreenState extends ConsumerState<SwapScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: TriacoreAppBar(title: "Swap"),
      body: Center(
        child: Padding(
...
class _PegScreenState extends ConsumerState<PegScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: TriacoreAppBar(title: "Peg-in/out"),
      resizeToAvoidBottomInset: false,
      body: Padding(
        padding: EdgeInsets.all(16.0),
        child: Column(
                          ...
                          showDialog(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                ...
                                content: const Text(
                                  "Caso essa opção seja selecionada, um endereço será requisitado para enviar os seus ativos. Senão, um endereço da própria carteira Triacore será utilizado. \nSelecione essa opção para enviar para uma cold wallet.",
                                ),
                                actions: [
                                  TextButton(
                                    onPressed: () {
                          ...
                          showDialog(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                ...
                                content: const Text(
                                  """Caso essa opção seja selecionada, você poderá converter seus ativos de uma wallet externa. Senão, os valores da própria carteira Triacore serão convertidos automaticamente.

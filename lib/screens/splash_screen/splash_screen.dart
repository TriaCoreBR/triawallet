...
import 'package:triacore_mobile/providers/wallet/wallet_sync_provider.dart';
import 'package:triacore_mobile/repositories/wallet/bitcoin.dart';
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Spacer(),
            Image.asset(
              'assets/images/triacore-logo.png',
              width: 150,
              height: 150,
            ),
            SizedBox(height: 20),
